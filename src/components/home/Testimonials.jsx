  ...
  return (
    <div style={{ paddingTop: '48px', paddingBottom: '48px', backgroundColor: '#F8F9FA' }}>
      <Container maxWidth="lg" sx={{ px: { xs: 2, sm: 3 } }}>
        ...
        <div
          style={{ position: 'relative', maxWidth: '896px', margin: '0 auto', paddingLeft: '40px', paddingRight: '40px' }}
          ...
          >
            <CardContent sx={{ p: { xs: 3, md: 6 } }}>
              <div style={{ 
                ...
                <div style={{ flexGrow: 1, textAlign: isMobile ? 'center' : 'left', width: '100%' }}>
                  <Quote size={isMobile ? 24 : 32} style={{ color: '#DC143C', marginBottom: '12px', opacity: 0.3 }} />
                  <Typography
                    variant="h6"
                    sx={{
                      color: '#000000',
                  ...
                  <div style={{ display: 'flex', gap: '4px', marginTop: '12px', justifyContent: isMobile ? 'center' : 'flex-start' }}>
